...
BOOST_AUTO_TEST_CASE(should_produce_correct_token_map)
{
    test_token_map<headers::cache_control>();
    test_token_map<headers::pragma>();
}

BOOST_AUTO_TEST_CASE(should_produce_correct_token_vector)
{
...
BOOST_AUTO_TEST_CASE(should_produce_correct_date)
{
    headers::date d;
...
BOOST_AUTO_TEST_CASE(should_produce_correct_transfer_encoding)
{
...
BOOST_AUTO_TEST_CASE(should_produce_correct_upgrade)
{
    headers::upgrade u;
...
BOOST_AUTO_TEST_CASE(should_produce_correct_via)
{
    headers::via v;
...
BOOST_AUTO_TEST_CASE(should_produce_correct_warning)
{
    headers::warning w;
...
BOOST_AUTO_TEST_CASE(should_produce_correct_accept)
{
    headers::accept a;
...
BOOST_AUTO_TEST_CASE(should_produce_correct_accept_charset)
{
...
BOOST_AUTO_TEST_CASE(should_produce_correct_accept_encoding)
{
...
BOOST_AUTO_TEST_CASE(should_produce_correct_accept_language)
{
...
BOOST_AUTO_TEST_CASE(should_produce_correct_authorization)
{
...
BOOST_AUTO_TEST_CASE(should_produce_correct_expect)
{
    headers::expect e;
...
BOOST_AUTO_TEST_CASE(should_produce_correct_host)
{
    headers::host h;
...
BOOST_AUTO_TEST_CASE(should_produce_correct_if_match)
{
...
BOOST_AUTO_TEST_CASE(should_produce_correct_content_length)
{
...
BOOST_AUTO_TEST_CASE(should_produce_correct_content_type)
{
