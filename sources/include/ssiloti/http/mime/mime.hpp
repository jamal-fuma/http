...
//      No sub-parts for simple parts, for example.
                ...
                {
                    return m_subparts.begin();
                }
                partIter        subpart_end()
                {
                    return m_subparts.end();
                }
                constPartIter   subpart_begin() const
                {
                    return m_subparts.begin();
                }
                constPartIter   subpart_end() const
                {
                    return m_subparts.end();
                }
...
//  Reading the raw headers
                ...
                constHeaderIter header_begin() const
                {
                    return m_headers.begin();
                }
                constHeaderIter header_end() const
                {
                    return m_headers.end();
                }
...
//  Body get/set methods
                ...
                mimeBody body_prolog() const
                {
                    return m_body;
                }
                mimeBody body_epilog() const
                {
                    return m_body_epilog;
                }
