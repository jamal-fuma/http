...
#include <ssiloti/http/media_type.hpp>
#include <ssiloti/http/comment.hpp>
#include <ssiloti/http/asterisk.hpp>
#include <ssiloti/http/entity_tag.hpp>

#include <ssiloti/uri/basic_uri.hpp>
...
// TODO: This should use an email address library
        ...
        struct byte_range_pre
        {
            std::size_t first;
            boost::optional<std::size_t> last;
        };
        struct byte_range_post
        {
            boost::optional<std::size_t> first;
            std::size_t last;
        };
